/*!
 *  --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
 *  amprku edit -- May 2017 --
 *
 *    goal is to make this tool do what I want it to at work. Maybe someone else can benefit as well.
 *
 *    adding:
...
;(function($, window, document, undefined)
{
    ...
    Plugin.prototype = {
        ...
        init: function()
        {
            ...
            //for drop-only units.
            list.dupEl   = $('<div class="' + list.options.duplicateClass + '"/>');
        ...
        dragStart: function(e)
        {
            ...
            this.dupEl.css('height', dragItem.height());
            ...
            if(dragItem.hasClass(this.options.dispenseClass)){
              dragItem.after(this.dupEl);
            }
            else{
